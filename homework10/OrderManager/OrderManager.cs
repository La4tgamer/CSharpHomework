...
namespace OrderManager {
    class OrderManager {
        ...
        static void Main(string[] args) {
            ...
            */
            ...
            while (true) {
                ...
                long ID = 0;
                Console.WriteLine("输入0显示所有订单，1添加订单，2删除订单，3查询订单(修改)，4保存，5读取，6退出");
                int a;
                try {
                ...
                if (a == 0) {
                    ...
                    try {
                        ...
                        order = orderService.FindOrderID(Console.ReadLine());
                    ...
                    if (long.TryParse(find, out ID)) {
                        //order = orderService.FindOrderID(ID);
                    }
                    else {
                        if (find == "按照消费") {
                    ...
                    orderService.Export(@"E:\C#Homework\CSharpHomework\homework6\OrderManager\bin\Debug\Orders.xml");
                }
                else if (a == 5) {
                    orderService.Import(@"E:\C#Homework\CSharpHomework\homework6\OrderManager\bin\Debug\Orders.xml");
                }
                else {
                    break;
                }
       ...
       public static void AddOrder(OrderService orderService) {
            ...
            try {
                //bianyixia 
                Order ooo = new Order(customer, ID);
                orderService.AddOrderEF(ooo);
